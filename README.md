...
I like building things that make engineering work more reliable:
...
💻 I work across **Java / Spring**, **TypeScript / React**, integrations, release flow, and engineering systems.

🧩 I care a lot about how software teams actually deliver:
- where work gets stuck
- why handoffs fail
- how to reduce delivery friction
- how to improve flow without turning everything into process theatre

🤖 I’m also actively experimenting with **AI-assisted engineering workflows**:
- agent-driven development
- structured review flows
- artifact-based collaboration
- reproducible engineering prompts
...
- practical experiments with real logs, structure, and trade-offs
